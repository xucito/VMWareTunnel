...
namespace CloudOSTunnel.Services.WSMan
{
    ...
    public class WSManRuntime : IWSManLogging
    {
        ...
        private readonly ILogger<WSManRuntime> logger;
        ...
        internal WSManRuntime(ILoggerFactory loggerFactory, VMWareClient client, string commandId, string loggingPrefix)
        {
        ...
        /// <param name="xml">XML request</param>
        /// <returns>Wsman protocol response</returns>
        public static string HandleSignalAction(XmlDocument xml, IWSManLogging logger)
        {
